			...
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							<li class="nav-item">
								<a class="nav-link" href="user.resultadosEXA.php"><b>&nbsp;<i class="fas fa-poll" style="color: #fff;"></i>&nbsp;&nbsp;Resultados</b></a>
                     </li>
                     
                     <!-- <li class="nav-item">
								<a class="nav-link" href="laboratorista.reactivos.php"><b>Reactivos</b></a>
                     </li>
							
							<li class="nav-item">
								<a class="nav-link" href="laboratorista.resultado.php"><b>Resultado Examen</b></a>
                     </li> -->
						...
						<?php 
							...
							$query = "SELECT * FROM user WHERE cedula = '$cedulaSession'";
						...
						<li class="nav-link dropdown">
							<a class="nav-link dropdown-toggle" style="color:#fff" href="#" id="navbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="far fa-user"></i>&nbsp;&nbsp;</i><b><?php echo $usuarioApe . " " . $usuarioNom; ?></b> </a>
